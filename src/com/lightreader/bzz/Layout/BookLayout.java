package com.lightreader.bzz.Layout;
...
public class BookLayout extends FrameLayout {
	...
	class BookView extends SurfaceView implements SurfaceHolder.Callback {
		...
		public void drawLB(Canvas canvas) {
			...
			ps.reset();
			ps.setAntiAlias(true);
			Shader lg2 = new LinearGradient(scrollX, scrollY, 0, contentHeight, new int[] { 0x00000000, 0x33000000, 0x00000000 }, new float[] { 0.35f, 0.5f, 0.65f }, Shader.TileMode.CLAMP);
			ps.setShader(lg2);
			canvas.drawRect(0, 0, contentWidth, contentHeight, ps);
		}
		...
		public void drawRT(Canvas canvas) {
			...
			ps.reset();
			ps.setAntiAlias(true);
			Shader lg2 = new LinearGradient(scrollX, scrollY, contentWidth, 0, new int[] { 0x00000000, 0x33000000, 0x00000000 }, new float[] { 0.35f, 0.5f, 0.65f }, Shader.TileMode.CLAMP);
			ps.setShader(lg2);
			canvas.drawRect(0, 0, contentWidth, contentHeight, ps);
		}
		...
		public void drawRB(Canvas canvas) {
			...
			ps.reset();
			Shader lg2 = new LinearGradient(scrollX, scrollY, contentWidth, contentHeight, new int[] { 0x00000000, 0x33000000, 0x00000000 }, new float[] { 0.35f, 0.5f, 0.65f }, Shader.TileMode.CLAMP);
			ps.setShader(lg2);
			canvas.drawRect(0, 0, contentWidth, contentHeight, ps);
		}
